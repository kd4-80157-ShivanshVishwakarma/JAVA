...
public class MainTest {
	...
	public static void loadBook() {
		ArrayList<StoreBook> lis;
		try(FileInputStream fin = new FileInputStream("../Assign_13_2/book1.txt")) {
			try(ObjectInputStream oin = new ObjectInputStream(fin)) {
//				while(true) {
//					
//					System.out.println();
//				}
				lis=(ArrayList<StoreBook>) oin.readObject();
				lis.forEach(c -> System.out.println(c));
